"""
Django settings for Multy_Shop project.
...
SECRET_KEY = 'django-insecure-si#*l2j=ptl94!$k^x57zk$fg=a2h=^r_@&-!i$-ox57vh=2^4'
...
WSGI_APPLICATION = 'Multy_Shop.wsgi.application'
